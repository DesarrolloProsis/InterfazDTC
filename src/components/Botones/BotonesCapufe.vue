<template>
    <div>
        <div class="flex justify-center mt-2 sm:mt-14" v-if="tipoBotones">
            <div class="mb-66">       
                <div class="flex">     
                    <div class="border-black border-2 rounded-lg m-8 sm:m-4 sm:p-3 shadow-xl h-72 sm:64">
                    ...
                    <div class="border-black border-2 rounded-lg m-8 sm:m-4 sm:p-3 shadow-xl h-72 sm:64" v-if="tipoUsuario == 7">
