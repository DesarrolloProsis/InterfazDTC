<template>
    <div class="mr-10 -mt-3 sm:mr-0 sm:ml-4 sm:mt-0 w-full font-titulo" :class="{'sm:-ml-1': tipo =='Diagnostico', 'sm:-ml-1': tipo =='Ficha'}">        
        ...
        <div v-if="reporteDataInsertada" class="-ml-4" :class="{'w-75 ml-4 mr-4 mt-4 -mb-4 sm:-mt-18 sm:-ml-4 lg:ml-73' : tipo == 'Diagnostico',
            ...
            'w-1/3 ml-5 sm:ml-0 sm:w-66 sm:-mb-10 lg:ml-73' : tipo == 'Ficha', 'w-1/3 ml-5 sm:ml-1 sm:w-66 sm:-mb-10 lg:ml-73' :$route.params.tipoVista == 'Editar' }">
            <div class="inline-flex h-40 border border-gray-400 rounded-lg w-full sm:w-66" :class="{'sm:w-full mt-0 sm:mt-2': tipo =='Diagnostico', 'sm:w-full mt-0 sm:mt-2': tipo =='Ficha'}" v-if="!cargandoImagen">
                ...
                <div class="w-1/3 border-2 relative border-gray-600 inline-block border-dashed text-center rounded-lg"
                    ...
                    <div class="sm:-mt-4">
                        ...
                        <img src="../assets/img/more.png" class="p-5 w-auto mx-auto h-32 sm:w-10 sm:h-10 sm:p-1 sm:mt-16" :class="{'sm:h-16 sm:w-16': tipo =='Diagnostico', 'sm:h-16 sm:w-16': tipo =='Ficha'}" alt/>
