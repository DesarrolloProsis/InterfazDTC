<template>
    <div class="">
        ...
        <div class=" inline-flex">
            ...
            <div class="h-66 flex items-center justify-center text-5xl">
                <lazy-image v-if="cambiarImagenBool" :src="arrayImagenes.array_img[index_imagen_actual].image" :img-class="['h-66', 'w-screen', ' rounded-xl']" placeholder="https://media.giphy.com/media/swhRkVYLJDrCE/giphy.gif" />          
            </div>
