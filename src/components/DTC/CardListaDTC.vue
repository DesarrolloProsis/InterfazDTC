    ...
    <div class="w-66 sm:w-auto">
      ...
      <div class="flex-col md:flex-row flex mb-4">
        <div class="md:w-2/3">
          ...
          <p @click="editar_status_dtc()" v-if="TIPO_USUARIO.Supervisor_Tecnico == tipoUsuario || TIPO_USUARIO.Administracion == tipoUsuario"  class=" text-sm cursor-pointer text-blue-700 font-mono">Cambiar Estatus</p>
      ...
      <div v-if="showmenosMas">
        <div class="flex justify-between" v-if="true">
          <div class="">
            <button v-if="tipoUsuario == 9 || infoCard.statusId < 2" @click.prevent="borrar" class="bg-gray-300 hover:bg-gray-400 text-gray-800 text-xs font-bold py-2 px-2 ml-14 rounded inline-flex items-center border border-red-700 mt-1">
