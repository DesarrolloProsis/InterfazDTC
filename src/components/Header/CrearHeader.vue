<template>
  <div class="sm:text-xs">    
    ...
    <div>
      ...
      <!-- Div Cabeza -->
      <div class=" border-black mx-10 px-4 flex sm:flex-col justify-center">
        <div class="mt-4 md:m-6 md:mt-9 lg:m-12 xl:m-8 xl:p-8 flex justify-center">
          <img src="../../assets/img/prosis-logo.jpg" class="h-full w-full md:h-10 lg:h-14 xl:h-20" />
        </div>
        <div class="my-4 lg:m-12 lg:mt-8 xl:m-8 xl:p-8 xl:px-20 flex justify-center font-titulo">
          <span class="text-3xl text-center h-24 text-gray-800 font-titulo font-bold p-4 sm:text-sm md:text-lg lg:text-xl">Dictamen Tecnico y Cotizacion</span>
        </div>
        <div class="-mt-4 md:m-8 md:mt-10 lg:m-12 lg:mt-16 xl:m-8 xl:p-8 xl:px-20 flex justify-center font-titulo">
          <span class="xl:m-8 xl:text-lg font-semibold">Referencia:</span>
          <span class="xl:my-8 xl:text-lg font-bold">{{ datosSinester.ReferenceNumber }}</span>
        </div>
      </div>

      <!-- Div Cuerpo -->
      <div class="flex justify-center sm:flex-col mt-8 lg:-mt-4 lg:text-base xl:mb-20">
        <!-- Div PrimerFlex -->
        <div class="my-4 mx-4 xl:mx-20 text md:-my-2 md:text-sm">
          ...
          <div class="my-6 text-sm" :class="{'hidden': boolCambiarPlaza == false}">
          ...
          <div class="my-6 text-sm" :class="{'hidden': boolCambiarPlaza == true}">
            <div class="sm:hidden md:hidden lg:hidden w-6 absolute ml-60 mt-1">
              ...
              <font-awesome-icon icon="fa-solid fa-circle-info" class="text-blue-600 xl:w-5 xl:h-5 flex items-center"/>
              </span>
            ...
            <span class="xl:my-6 xl:text-lg font-semibold font-titulo">Cambiar Plaza: </span>
            <p class="xl:ml-12 xl:-mt-7 -mx-2 md:-mx-6"><SelectPlaza class="" @actualizar-plaza="cambiar_plaza" :fullPlazas="true" :tipo="'tipoPlazaSelect'"></SelectPlaza></p>
          </div>
        </div>
        <!-- Div SegundoFlex -->
        <div class="mx-4 lg:mx-20 xl:mx-10 md:text-sm">
          
          <div class="my-8 md:my-4 xl:my-6">
            <div class="text-xl font-titulo font-bold">
              <h6 class="sm:text-sm md:text-base">En caso de Siniestro</h6>
            </div>
          </div>
          ...
          <ValidationProvider name="NoSiniestro" immediate rules="max:30|uniqueSinester" :custom-messages="{ uniqueSinester: 'Numero de siniestro repetido' }" v-slot="{ errors }">                            
            <p class="xl:w-1/2 text-md xl:mb-1 font-medium text-gray-900">No. Siniestro:</p>
            <input v-model="datosSinester.SinisterNumber" class="w-3/4 xl:w-full font-titulo font-normal is_valid" :class="{'no_valid':$route.params.tipoFalla == 3}" :disabled='$route.params.tipoFalla == 3' name="NoSiniestro" type="text"/>
            <span class="text-red-600 text-xs block">{{ errors[0] }}</span>
          </ValidationProvider> 

          <div class="my-4 xl:my-6">
            ...
            <p class="xl:w-1/2 xl:mt-2 text-md xl:mb-1 font-medium text-gray-900">No. Reporte:</p>
          ...
          <div class="pr-2 font-titulo">
            ...
            <div class="my-4 xl:my-6">
              <ValidationProvider name="FechaSiniestro" immediate rules="required|fechaMenorNow" :custom-messages="{ fechaMenorNow: 'La fecha debe ser menor que la fecha actual' }" v-slot="{ errors }">
                <p class="text-md xl:mb-1 font-medium text-gray-900">Fecha de Siniestro:</p>
          ...
          <div class="my:4 xl:pr-2 font-titulo xl:my-6">
            ...
            <ValidationProvider name="FolioFalla" immediate rules="max:60"  v-slot="{ errors }">
              <p class="text-md xl:mb-1 font-medium text-gray-900">Folio de Falla:</p>              
          ...
          <div class="my-4 xl:pr-2 font-titulo xl:my-6">
            ...
            <ValidationProvider name="FechaFalla" immediate rules="required|fechaMenorNow" :custom-messages="{ fechaMenorNow: 'La fecha debe ser menor que la fecha actual' }"  v-slot="{ errors }">
              <p class="text-md xl:mb-1 font-medium text-gray-900">Fecha de Falla:</p>
        ...
        <!-- Div TerceroFlex -->
        <div class="mx-4 md:-my-4 xl:mx-20 md:text-sm">

          <div class="my-8 text-left xl:my-6">
          ...
          <div class="my-4 xl:pr-2 font-titulo xl:my-6">
            ...
            <ValidationProvider name="tipo" immediate rules="required"  v-slot="{ errors }">
              <p class="text-md font-medium xl:mb-1 text-gray-900">Tipo de Descripción:</p>
              <select v-model="datosSinester.TypeDescriptionId" @change="tipoDescripcion" class="md:w-1/2 xl:w-3/4 font-titulo font-normal is_valid" type="text" name="TipoDescripcion">                
          ...
          <div class="my-4 xl:pr-2 font-titulo xl:my-6">
            <div class="xl:pr-2 font-titulo">
              <ValidationProvider name="diagnostico" immediate rules="required"  v-slot="{ errors }">
                ...
                <select v-model="datosSinester.Diagnosis"  class="md:w-1/2 xl:w-3/4 font-titulo font-normal is_valid" type="text" name="TipoDescripcion">                
          ...
          <div class="my-4 xl:pr-2 font-titulo xl:my-6">
            ...
            <ValidationProvider name="FechaEnvio" immediate rules="required"  v-slot="{ errors }">
              <p class="text-md xl:mb-1 font-medium text-gray-900">Fecha de Envio:</p>
              <input v-model="datosSinester.ShippingElaboracionDate" class="md:w-1/2 w-3/4 is_valid" type="date" name="FechaEnvio" onkeydown="return false"/>
              <span class="text-red-600 text-xs block">{{ errors[0] }}</span>
            </ValidationProvider>
          </div>

          <div class="my-4 xl:pr-2 font-titulo xl:my-2 ">
            <span class="text-lg font-semibold sm:text-xs md:text-sm lg:text-base">Tecnico Responsable:</span><br>
            <span class="text-lg sm:text-xs md:text-sm lg:text-base" style="font-weight: normal">{{ headerSelecionado.nombre }}</span>
          </div>
          ...
          <div class="xl:pr-2 font-titulo">
            ...
            <label v-else class="text-lg " style="font-weight: normal"><span class="font-semibold font-titulo text-lg sm:text-xs md:text-sm lg:text-base">Unidad Regional: {{ headerSelecionado.regionalCoordination.slice(16) }}</span></label>
          </div>

          <div class="pr-2 font-titulo">
            <span class="font-normal text-lg sm:text-xs md:text-sm lg:text-base">Centro de Servicio: </span>
    ...
    <div class="sm:my-8 md:my-10 lg:my-12 flex justify-center bg-white" :class="{ 'pointer-events-none': modalReferencia, 'opacity-75':modalReferencia }">
      <!--
      <ValidationObserver ref="observer">  
    ...
    ////                  MODAL RREFERENCIAS                         ////
    ////////////////////////////////////////////////////////////////////-->
    <div class="hidden absolute justify-center inset-x-0 top-0 mt-66 opacity-100">
