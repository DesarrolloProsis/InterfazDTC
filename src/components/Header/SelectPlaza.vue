<template>
    <div class="font-titulo">
        <div v-if="forma == ''">
            ...
            <p class="w-48 input ml-20 sm:ml-1 md:mx-auto" :class="{'sm:w-32':vista=='Actividades', 'sm:w-62':vista=='ConcentradoDTC', 'sm:w-62':vista=='GMMEP', 'xl:-ml-1 sm:w-full sm:ml-0':vista=='Inventario', 'sm:w-full sm:-ml-0':vista=='Encargados','xl:ml-0 sm:w-full sm:-ml-0':vista=='DTCFacturados'}">
