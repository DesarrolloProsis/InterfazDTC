<template>
    <div class="font-titulo">
        <div v-if="forma == ''">
            ...
            <p class="w-48 input ml-20 sm:-ml-1 sm:w-66">
            <select v-model="plazaSelect" @change="actualizar_plaza" :disabled="boolCambiarPlaza" class="w-48 is_valid" :class="{'sm:w-66 sm:-ml-1': vista='TablaAct'}" type="text" name="TipoDescripcion">
