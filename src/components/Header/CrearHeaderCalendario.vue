        ...
        <div class="felx-auto ml-2 mr-2 mt-2 -mb-6">
            <div class="grid grid-cols-1 xl:grid-cols-2 sm:grid-cols-1 sm:px-2">
                ...
                <div class="grid grid-cols-1 mx-auto ">
                    ...
                    <div class="flex m-3 h-12 sm:grid sm:grid-cols-1 sm:mx-auto sm:-mt-2">
                        <p class="font-titulo font-semibold sm:text-center">Acciones:</p>
                        <multiselect v-model="value" @close="acciones_mapper()" class="w-68 sm:w-65" placeholder="Seleccione una Accion" label="title" track-by="title" :options="opticones_select_acciones()" :option-height="100" :custom-label="customLabel" :show-labels="false">
