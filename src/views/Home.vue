<template>
  <div>    
    ...
    <div class="flex justify-center mt-1 mb-10 sm:mt-14" v-if="acultarPrimerosBotones">
      <div class>
        <div class="flex sm:grid grid-cols-2">
          <div class="Home animacion h-69 sm:m-4 sm:p-3 sm:h-66" v-if="typeUser == 7 || typeUser == 1 ||typeUser == 2 || typeUser == 3 || typeUser == 4 || typeUser == 5 || typeUser == 10">
            <router-link :to="`home/${typeUser}/preventivo`" class="text-center">
              <img src="../assets/img/wrench.png" height="200" width="200" class="m-10 mt-20 mb-20 sm:m-1 sm:mt-12 sm:mb-12"/>
          ...
          <div class="Home animacion h-69 sm:m-4 sm:p-3 sm:h-66">
            <router-link :to="`home/${typeUser}/correctivo`" class="text-center">
              <img src="../assets/img/mantenimientoCorrectivo.png" height="200" width="200" class="m-10 mt-20 mb-20 sm:m-1 sm:mt-12 sm:mb-12"/>
          ...
          <div class="Home animacion h-69 sm:m-4 sm:p-3 sm:h-66 sm:mb-16">
            <router-link to="/Configuracion" class="text-center cursor-pointer">
              <img src="../assets/img/engranajes.png" height="200" width="200" class="m-10 mt-20 mb-20 sm:m-1 sm:mt-12 sm:mb-12"/>
