<template>
  <div>
    ...
    <div class="flex justify-center mt-10 mb-10 sm:mt-14" v-if="acultarPrimerosBotones">
      <div class>
        <div class="flex">
          <div class="border-black border-2 rounded-lg m-8 sm:m-4 sm:p-3 shadow-xl h-73 sm:h-66 hover:bg-gray-400" v-if="typeUser == 7 || typeUser == 1 ||typeUser == 2 || typeUser == 3 || typeUser == 5">
